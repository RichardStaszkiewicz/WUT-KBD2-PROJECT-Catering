...
AS
  FUNCTION F_ID_FIRMY_GLOWNEJ RETURN number DETERMINISTIC;
...
CREATE INDEX KONTRAHENCI_ADRESY_INDEX ON KONTRAHENCI (ID_ADRESU ASC);
...
ALTER TABLE KONTRAHENCI
ADD CONSTRAINT KONTRAHENCI_ADRESY_FK FOREIGN KEY
(
  ID_ADRESU
)
REFERENCES ADRESY
